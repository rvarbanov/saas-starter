...
- **Auth flow:** protected routes (`/dashboard`, `/settings`) redirect unauthenticated users to the WorkOS hosted login (OAuth works with the committed `WORKOS_CLIENT_ID`). Completing sign-in needs a real WorkOS test account.
