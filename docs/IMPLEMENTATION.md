...
### 11.2 Integration tests in Docker
...
- `dev` — Docker Compose local stack (`docker compose up --build` or project wrapper script).  
- `test` — Docker Compose command for Vitest (`*.spec.*` colocated).  
